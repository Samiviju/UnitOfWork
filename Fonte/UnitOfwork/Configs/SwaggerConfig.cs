    ...
    public static class SwaggerConfig
    {
        ...
        public static IServiceCollection AddSwaggerSettings(this IServiceCollection services)
        {
            services.AddSwaggerGen(swagger =>
            {
                ...
                var documentacaoWebAPI = Path.Combine(AppContext.BaseDirectory, "UnitOfwork.xml");
                var documentacaoDominioWebAPI = Path.Combine(AppContext.BaseDirectory, "Domain.xml");

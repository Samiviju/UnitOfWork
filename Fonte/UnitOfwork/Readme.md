...
WORKDIR /src
COPY ["UnitOfwork.csproj", "UnitOfwork/"]
RUN dotnet restore "UnitOfwork/UnitOfwork.csproj"

WORKDIR "/src/UnitOfwork"
COPY . .
RUN dotnet build "UnitOfwork.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "UnitOfwork.csproj" \
...
Execute unit tests
```
    cd "UnitOfwork/test/UnitOfwork.Tests"
    dotnet test
```

Deploy application
```
    cd "UnitOfwork/src/UnitOfwork"
